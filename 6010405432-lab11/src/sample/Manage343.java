...
public class Manage343 implements TeamManage{
    public ArrayList<Integer> randomDefender = new ArrayList<>();
    public ArrayList<Integer> randomMidFielder = new ArrayList<>();
    public ArrayList<Integer> randomForward = new ArrayList<>();
